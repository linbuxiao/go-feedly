...
func (s *FeedCollectionsService) List(ctx context.Context) (*FeedCollectionsListResponse, *resty.Response, error) {
	...
	resp, err := s.client.Client().R().SetResult(&result).SetContext(ctx).Get("/collections")
...
func (s *FeedCollectionsService) Get(ctx context.Context, id string) (*FeedCollection, *resty.Response, error) {
	...
	resp, err := s.client.Client().R().SetResult(&result).SetContext(ctx).Get(url)
	return &result, resp, err
}
...
func (s *FeedCollectionsService) CreateOrUpdateOne(ctx context.Context, params *FeedCollectionsCreateOrUpdateOneRequest) (*resty.Response, error) {
	return s.client.Client().R().SetBody(params).SetContext(ctx).Post("/collections")
}
...
func (s *FeedCollectionsService) AddFeed(ctx context.Context, params *FeedCollectionsAddFeedRequest) (*resty.Response, error) {
	...
	return s.client.Client().R().SetContext(ctx).SetBody(params).Put(url)
}

type FeedCollectionsAddMultipleFeedsRequest []FeedRo

func (s *FeedCollectionsService) AddMultipleFeeds(ctx context.Context, params *FeedCollectionsAddMultipleFeedsRequest) {
